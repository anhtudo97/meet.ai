...
const DashboardUserButton = () => {
  ...
  if (isMobile) {
    return (
      <Drawer>
        <DrawerTrigger className="rounded-lg border border-border/10 p-3 w-full flex items-center justify-between bg-white/5 hover:bg-white/10 duration-200 transition-colors overflow-hidden gap-x-2">
          {
            data.user.image ? (
              <Avatar>
              ...
              <GeneratedAvatar seed={data.user.name || "User"} variant='botttsNeutral' className='size-9 mr-3' />
            )
          }
